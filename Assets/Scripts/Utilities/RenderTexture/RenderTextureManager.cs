...
public class RenderTextureManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        renderTexture = new RenderTexture(512, 512, UnityEngine.Experimental.Rendering.GraphicsFormat.R8G8B8A8_UNorm, UnityEngine.Experimental.Rendering.GraphicsFormat.D32_SFloat_S8_UInt);
